...
class _CreateHouseholdRoutinePageState
  ...
  Future<void> _save() async {
    ...
    final routine = await widget.controller.createRoutine(
    ...
    if (routine == null) {
      _showMessage(
        widget.controller.errorMessage ?? 'Não foi possível criar a rotina.',
      );
      return;
    }
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const Text(
            'A próxima etapa só é criada quando a anterior for concluída. '
            'O intervalo começa a contar a partir da conclusão real.',
          ),
      ...
      bottomNavigationBar: SafeArea(
        ...
        child: FilledButton.icon(
          ...
          label: Text(_saving ? 'Criando...' : 'Criar e iniciar rotina'),
        ),
      ),
    );
  }
