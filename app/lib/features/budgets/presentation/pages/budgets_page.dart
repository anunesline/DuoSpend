            ...
            : RefreshIndicator(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    Text(
                      widget.wallet.isShared
                          ? 'Planejamento compartilhado da carteira'
                          : 'Planejamento da sua carteira',
                      style: const TextStyle(
                    ...
                    if (budgets.isEmpty)
                      const Padding(
                        ...
                        child: Center(
                          child: Text('Nenhum orçamento neste mês.'),
                        ),
                      ),
                    ...budgets.map(
                      (item) => _BudgetCard(
                    ...
                    ...controller.budgets
                        ...
                        .map(
                          (item) => ListTile(
                            ...
                            subtitle: Text(
                              '${DateFormat('MM/yyyy').format(item.month)} · Arquivado',
                            ),
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(
      ...
      children: [
        ...
        Text(
          'de ${money.format(limit)} planejados',
        ...
        ClipRRect(
          ...
          child: LinearProgressIndicator(
            ...
            valueColor: const AlwaysStoppedAnimation(DuoColors.primaryLight),
          ),
        ),
        ...
        Row(
          children: [
            ...
            const Spacer(),
            Text(
              budgetCount == 1 ? '1 categoria' : '$budgetCount categorias',
              style: const TextStyle(
                color: DuoColors.textSecondary,
                fontSize: 11,
              ),
          ...
          children: [
            Row(
              children: [
                ...
                if (budget.isPaused) const Chip(label: Text('Pausado')),
                if (canManage)
            ...
            const SizedBox(height: 10),
            Text(
              '${money.format(consumption.spentAmount)} de ${money.format(budget.limitAmount)}',
            ),
            const SizedBox(height: 4),
            Text(
              consumption.remainingAmount >= 0
                  ? '${money.format(consumption.remainingAmount)} restantes · $label'
                  : '${money.format(-consumption.remainingAmount)} acima do limite · $label',
